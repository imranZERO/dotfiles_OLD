...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal ctermbg=235 ctermfg=251 cterm=NONE guibg=#1e1d1d guifg=#c6c6c6 gui=NONE
    ...
    hi Constant ctermbg=bg ctermfg=140 cterm=NONE guibg=bg guifg=#d7af5f gui=NONE
    hi Identifier ctermbg=bg ctermfg=251 cterm=NONE guibg=bg guifg=#6B8E23 gui=NONE
    hi Statement ctermbg=bg ctermfg=243 cterm=NONE guibg=bg guifg=#A08563 gui=NONE
    hi Operator ctermbg=bg ctermfg=251 cterm=NONE guibg=bg guifg=#c6c6c6 gui=NONE
    hi PreProc ctermbg=bg ctermfg=243 cterm=NONE guibg=bg guifg=#A08563 gui=NONE
    hi Type ctermbg=bg ctermfg=251 cterm=NONE guibg=bg guifg=#6B8E23 gui=NONE
    hi Special ctermbg=NONE ctermfg=243 cterm=NONE guibg=NONE guifg=#A08563 gui=NONE
    hi Error ctermbg=NONE ctermfg=132 cterm=NONE guibg=NONE guifg=#af5f87 gui=NONE
    hi Warning ctermbg=NONE ctermfg=179 cterm=NONE guibg=NONE guifg=#d75f5f gui=NONE
    hi ModeMsg ctermbg=NONE ctermfg=243 cterm=NONE guibg=NONE guifg=#A08563 gui=NONE
    ...
    hi StatusLine ctermbg=237 ctermfg=140 cterm=NONE guibg=#3a3a3a guifg=#d7af5f gui=NONE
    hi StatusLineNC ctermbg=236 ctermfg=243 cterm=NONE guibg=#303030 guifg=#A08563 gui=NONE
    ...
    hi CursorLineNr ctermbg=236 ctermfg=140 cterm=NONE guibg=#303030 guifg=#d7af5f gui=NONE
    hi Cursor ctermbg=140 ctermfg=251 cterm=NONE guibg=#d7af5f guifg=#c6c6c6 gui=NONE
    ...
    hi SignColumn ctermbg=NONE ctermfg=243 cterm=NONE guibg=NONE guifg=#A08563 gui=NONE
    ...
    hi PmenuSel ctermbg=236 ctermfg=140 cterm=NONE guibg=#303030 guifg=#d7af5f gui=NONE
    ...
    hi Folded ctermbg=234 ctermfg=243 cterm=NONE guibg=#1c1c1c guifg=#A08563 gui=NONE
    hi SpecialKey ctermbg=NONE ctermfg=243 cterm=NONE guibg=NONE guifg=#444444 gui=NONE
    hi IncSearch ctermbg=167 ctermfg=235 cterm=NONE guibg=#d75f5f guifg=#1e1d1d gui=NONE
    hi Search ctermbg=140 ctermfg=235 cterm=NONE guibg=#d7af5f guifg=#1e1d1d gui=NONE
    hi Directory ctermbg=NONE ctermfg=140 cterm=NONE guibg=NONE guifg=#d7af5f gui=NONE
    ...
    hi helpHyperTextJump ctermbg=bg ctermfg=140 cterm=NONE guibg=bg guifg=#d7af5f gui=NONE
